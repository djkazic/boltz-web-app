const dict = {
    en: {
        ...
        fast: "Fast",
        l2: "Built on Layer 2",
        l2_sub: "Eldamar utilizes Layer 2 scaling technologies like the Lightning Network",
        assets_sub: "Lightning / Bitcoin / Liquid",
        safe: "Safe",
        non_custodial: "Non-Custodial",
        non_custodial_sub:
            "Swaps on Eldamar are atomic, cryptography ensures that users are always in control of their money",
        ...
        create_swap_subline: "Payment Includes Network and Eldamar Fee",
        ...
        transaction_refunded: "Eldamar has refunded the Transaction",
        ...
        api_offline_msg:
            "Could not connect to the Eldamar API, please try again later",
    ...
    de: {
        ...
        l2_sub: "Eldamar nutzt Layer-2 Skalierungstechnologien wie das Lightning-Netzwerk",
        assets_sub: "Lightning / Bitcoin / Liquid",
        safe: "Sicher",
        non_custodial: "Non-Custodial",
        non_custodial_sub:
            "Swaps auf Eldamar sind atomar, Kryptografie stellt sicher, dass Nutzer stets die Kontrolle über ihre Bitcoin behalten",
        ...
        assets: "Multi-layer",
        footer: "Gemacht mit ❤️ von djkazic",
        ...
        create_swap_subline: "Zahlung beinhaltet Netzwerk- und Eldamargebühr",
        ...
        transaction_refunded: "Eldamar hat die Transaktion erstattet.",
        ...
        api_offline_msg:
            "Konnte keine Verbindung zur Eldamar API herstellen. Bitte versuche es später noch einmal.",
        refund_explainer:
    ...
    es: {
        ...
        l2_sub: "Eldamar utiliza tecnologías de segunda capa como la red de Lightning",
        assets_sub: "Lightning / Bitcoin / Liquid",
        safe: "Seguro",
        non_custodial: "Sin Custodia",
        non_custodial_sub:
            "Los intercambios en Eldamar son atomicos, la criptografía garantiza que los usuarios siempre tienen el control de su Bitcoin",
        ...
        assets: "Multicapa",
        footer: "Hecho con ❤️ por el equipo de Eldamar",
        ...
        create_swap_subline:
            "El pago incluye la comisión de red y servicio de Eldamar",
        ...
        transaction_refunded: "Eldamar ha reembolsado la transacción!",
        ...
        api_offline_msg:
            "No se pudo conectar a la API de Eldamar, por favor inténtelo de nuevo más tarde!",
        refund_explainer:
    ...
    zh: {
        ...
        fast: "快速",
        l2: "建立在二层网络之上",
        l2_sub: "Eldamar利用像闪电网络这样的二层网络扩展技术",
        assets_sub: "闪电网络/比特币/Liquid",
        safe: "安全",
        non_custodial: "非托管",
        non_custodial_sub:
            "Eldamar上的交换是原子式,密码学确保用户始终掌握自己的资金",
        node: "闪电网络节点",
        ...
        assets: "多层",
        footer: "Eldamar团队倾情 ❤️ 制作",
        create_channel: "创建闪电网络通道",
        create_channel_subline: "通道入站或出站容量",
        create_swap: "创建原子交换",
        create_swap_subline: "付款包括网络和Eldamar服务费",
        cancel_swap: "取消交换",
        new_swap: "新的交换",
        success_swap: "交换成功",
        ...
        transaction_refunded: "Eldamar已退款交易!",
        refunded: "交换已退还",
        broadcasted: "退款已广播",
        locktime_not_satisfied: "未满足锁定时间要求",
        already_refunded: "交换已经退还",
        api_offline: "API离线",
        api_offline_msg: "无法连接到Eldamar API,请稍后重试",
